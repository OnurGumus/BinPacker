...
let items = [
    {Dim = {Width = 100; Height = 100; Length = 14} ;Id = "big1" ; Tag ="#880000"};
      ...
      {Dim = {Width = 45; Height = 100; Length = 30} ; Id = "small22";Tag ="lime"};
         {Dim = {Width = 100; Height = 100; Length = 100} ;Id = "big3" ; Tag ="green"};
     {Dim = {Width = 100; Height = 100; Length = 100} ; Id = "big4";Tag ="blue"};
    {Dim = {Width = 45; Height = 100; Length = 30} ; Id = "2";Tag ="pink"};
    {Dim = {Width = 45; Height = 100; Length = 30} ; Id = "3";Tag ="lime"};
          {Dim = {Width = 100; Height = 100; Length = 100} ;Id = "1" ; Tag ="green"};
    {Dim = {Width = 100; Height = 95; Length = 100} ; Id = "4";Tag ="blue"};
     ...
     {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "10";Tag ="yellow"};
     {Dim = {Width = 5; Height = 75; Length = 200} ; Id = "11";Tag ="aqua"};
     {Dim = {Width = 50; Height = 150; Length = 56} ; Id = "12";Tag ="pink"};
     {Dim = {Width = 50; Height = 75; Length = 200} ; Id = "13";Tag ="white"};
     ...
     {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "17";Tag ="aqua"};
     {Dim = {Width = 25; Height = 75; Length = 200} ; Id = "18";Tag ="pink"};
     {Dim = {Width = 85; Height = 150; Length = 200} ; Id = "19";Tag ="green"};
     ...
     {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "23";Tag ="white"};
     {Dim = {Width = 50; Height = 15; Length = 30} ; Id = "24";Tag ="navy"};
     {Dim = {Width = 50; Height = 100; Length = 30} ; Id = "25";Tag ="aqua"};
     ...
     {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "31";Tag ="white"};
     {Dim = {Width = 50; Height = 75; Length = 30} ; Id = "32";Tag ="navy"};
      {Dim = {Width = 50; Height = 100; Length = 30} ; Id = "33";Tag ="aqua"};
          {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "34";Tag ="yellow"};
     {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "35";Tag ="aqua"};
     {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "36";Tag ="pink"};
        {Dim = {Width = 50; Height = 125; Length = 200} ; Id = "27";Tag ="white"};
     {Dim = {Width = 50; Height = 75; Length = 30} ; Id = "28";Tag ="navy"};
     {Dim = {Width = 50; Height = 100; Length = 30} ; Id = "29";Tag ="aqu"};
       {Dim = {Width = 50; Height = 150; Length = 200} ; Id = "30";Tag ="#222222"};
...
let res = run containers items 1000. 0.9
