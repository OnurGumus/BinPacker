...
#load @"/Users/onurgumus/Repos/PlayGround/BinPacker/src/Shared/Shared.fs"
#load @"/Users/onurgumus/Repos/PlayGround/BinPacker/src/Shared/BinPacker/BinPackerUtil.fs"

open Shared.ClientModel
open Shared

let container: Container = { Coord = { X = 0L; Y =0L ; Z = 0L}; Dim = { Width = 10L; Height = 10L; Length = 10L}; Weight = 0}

open BinPackerUtil.SurfaceCalc
let item : Item =
    { Id = "";  NoTop = false; KeepBottom = false; KeepTop = false; Rotation = false; Tag= ""; Weight = 0;
        Dim = { Width = 10L; Height = 10L; Length = 5L} }
let itemPut : ItemPut = { Item = item ; Coord ={ X = 0L; Y =0L ; Z = 0L} }

let item2 : Item =
    { Id = "";  NoTop = false; KeepBottom = false; KeepTop = false; Rotation = false; Tag= ""; Weight = 0;
        Dim = { Width = 10L; Height = 10L; Length = 5L} }
let itemPut2 : ItemPut = { Item = item2 ; Coord ={ X = 0L; Y =0L ; Z = 5L} }

calculateSurfaceArea [itemPut; itemPut2] container